"""
Usage: run-study.py [--avg | --opt] --attack=<attack-type> --mal-workers=<list-of-uesr-ids> --mal-worker-percentage=<woker-percentage> --data-percentage=<data-percentage> --output-file=<output-filename>

Options:
  --avg    Average mode
  --opt    Optimized mode
  -attck   Attack ID
  --mal-workers             List of ids indication malicious workers
  --mal-worker-percentage   Percentage of users
  --data-percentage  use right-hand side
  --output-file
"""
