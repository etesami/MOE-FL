class Arguments():
    def __init__(
        ...
        lr=None, momentum=None, weight_decay=None, shards_num=None, shards_per_worker_num=None, total_users_num=None, selected_users_num=None, load_fraction=None, server_data_fraction=None, 
